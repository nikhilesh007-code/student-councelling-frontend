          ...
          <div className="flex items-center gap-12">
            <div className="relative w-40 h-40 flex items-center justify-center shrink-0">
              <svg className="w-full h-full transform -rotate-90">
                ...
                <circle cx="80" cy="80" fill="transparent" r="70" stroke="#00a878" strokeDasharray="440" strokeDashoffset={440 - (440 * completionPercentage) / 100} strokeLinecap="round" strokeWidth="12" />
              </svg>
