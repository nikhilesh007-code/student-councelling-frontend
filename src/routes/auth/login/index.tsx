  ...
  return (
    ...
    >
      <style>{`
        ...
        @keyframes glow {
          0%, 100% { box-shadow: 0 0 10px rgba(0,166,118,0.4), 0 0 20px rgba(0,166,118,0.2); }
          50% { box-shadow: 0 0 25px rgba(0,166,118,0.8), 0 0 50px rgba(0,166,118,0.4); }
        }
        @keyframes wave {
        ...
        >
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-2xl font-bold text-gray-900">Career<span style={{ color: brandColor }}>AI</span></span>
            </div>
          ...
          <div className="z-10">
            ...
            >
              ...
              <motion.span
                ...
                style={{ color: brandColor, display: 'inline-block' }}
              >
                Your Career Journey
              </motion.span>
            </motion.h1>
            <motion.p
              ...
              className="text-gray-600 max-w-sm leading-relaxed mb-12"
            >
          ...
          <div className="mt-8 flex items-start gap-3">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: 'rgba(0,166,118,0.1)' }}>
          ...
          <div className="w-full max-w-md">
            <div className="text-center mb-10 relative">
              <div className="flex items-center justify-center gap-3 mb-2">
                ...
                <span className="wave-hand" style={{ fontSize: 40 }}>👋</span>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className="h-4 w-4 rounded border-gray-300" style={{ accentColor: brandColor }} />
                  <span className="text-sm text-gray-700">Remember Me</span>
                </label>
                <Link to="/auth/forgot-password" className="text-sm font-medium" style={{ color: brandColor }}>Forgot Password?</Link>
              </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center gap-2 text-white py-3.5 px-4 rounded-xl font-semibold glow-button"
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-sm"><span className="px-3 bg-white text-gray-400 font-medium">OR</span></div>
              </div>
              ...
              >
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAH54fyTBhPJ8w2Jft1-NyTqqa7isdfKl53xOvSOjXdzCfBiCW6e6m0ZhKTeaRKRPsfRz-5w7BQ_ZhwoAYSrkTyLU-NTOxOmdEzW2V5Liz-nL6Yydu6zYzTY79A-BaHsDoNugdTEkzPD1PP6PEbtcW6ZF7vU9z-Ej-bMRp0PQR6mhr3L-fGXbnecbBTNwpyOaliy6nCDIK-o2HiDc8RsfVI32HhJ5v1GbQ_UzXtvIk8NnyyfX8P8QWy4sNDGm8ZGjcwwKNvEawnotKY" alt="Google" className="w-5 h-5" />
